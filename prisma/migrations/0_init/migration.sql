...
-- AddForeignKey
ALTER TABLE "menu" ADD CONSTRAINT "menu_chef_id_fkey" FOREIGN KEY ("chef_id") REFERENCES "chef"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "reservation" ADD CONSTRAINT "reservation_guest_id_fkey" FOREIGN KEY ("guest_id") REFERENCES "guest"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
